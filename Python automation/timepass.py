...
sentence01 =  "python, code, example, string, variable, loop, condition, list, function, class, module, import, library, output, input, variable, assignment, programming, algorithm, iteration, recursion, dictionary, tuple, string, concatenation, slicing, indexing, debugging, exception, syntax"

splitSente01 = sentence01.split()
sentence02 = "apple, banana, car, dog, elephant, flower, guitar, house, igloo, jelly, kangaroo, lion, monkey, night, owl, piano, queen, rainbow, sun, tiger, umbrella, volcano, whale, xylophone, yacht, zebra, cat, dolphin, moon, rabbit"
