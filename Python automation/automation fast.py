...
sentence01 =  "Santorini Maldives BoraBora Kyoto Bali AmalfiCoast Santorini Hawaii Fiji Positano Seychelles Dubai BanffNationalPark YosemiteNationalPark SwissAlps Paris Venice RioDeJaneiro CapeTown Sydney GrandCanyon GreatBarrierReef MachuPicchu Petra Santorini Maldives BoraBora Kyoto Bali AmalfiCoast Santorini Hawaii Fiji Positano"
splitSente01 = sentence01.split()
sentence02 = "Sahara ArabianDesert GobiAtacama Kalahari Simpson ArabianDesert Kyzylkum Dasht-e Kavir Great VictoriaDesert ChihuahuanDesert SonoranDesert Thar NamibDesert SyrianDesert Colorado Plateau GibsonDesert Dasht-e Lut WhiteDesert PatagoniaDesert KarakumDesert"
