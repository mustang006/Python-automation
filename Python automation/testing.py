...
sentence01 =  "TomHanks LeonardoDiCaprio JenniferLawrence JohnnyDepp MerylStreep BradPitt AngelinaJolie DenzelWashington ScarlettJohansson WillSmith JuliaRoberts RobertDowneyJr ChrisHemsworth CharlizeTheron RyanReynolds EmmaWatson DwayneJohnson NicoleKidman SamuelLJackson KateWinslet MattDamon NataliePortman HughJackman SandraBullock ChrisEvans AnneHathaway MorganFreeman KeiraKnightley MarkWahlberg CateBlanchett LiamNeeson ZoeSaldana salmankhan shahrukhkhan bobbydeol"
splitSente01 = sentence01.split()
sentence02 = "PastaCarbonara SushiTempura ChickenParmesan BeefStroganoff TandooriChicken PadThai EggsBenedict ClamChowder ChickenAlfredo BakedZiti BeefTacos ShrimpScampi ChickenSatay LobsterBisque CremeBrulee ApplePie ChocolateMousse KeyLimePie Tiramisu CesarSalad MargheritaPizza EggsFlorentine ChickenQuesadilla FrenchOnionSoup"
...
for i in range(0,37):
    ...
    # for k in range(0, len(splitSente02)):
    #     gotoSearchBar()
